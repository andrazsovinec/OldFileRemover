...
def parse_duration(duration, unit):
...
parser.add_argument("duration", type=int, help="Age.")
parser.add_argument("unit", type=str, help="Time unit of duration.")

args = parser.parse_args()
folder = args.folder
duration = parse_duration(args.duration, args.unit)
